...
$(document).ready(function () {
    ...
    $('#zoom_01').ezPlus({
        ...
        zoomWindowBgColour: "none",
        borderSize: 0,
        zIndex: 8
    });

    $(".slide-dt-thumb .owl-item").mouseenter(function () {
        var thishref = $(this).find('.link-img-zoom').attr('href');
        var thisdata = $(this).find('.link-img-zoom').attr('data-large');
        $('.slide-dt-2 #cloudZoom img').attr('src', thishref);
        thisdata = 'url("' + thisdata + '")';
        $(".zoomWindowContainer > *").addClass('test').css({
            'background-image': thisdata,
